var sensors = function() {
	...
	module.draw = function(map) {
        ...
        for (var i = 0; i < sensorsNameLatLng.length; i++) {
            ...
            google.maps.event.addListener(marker, 'click', function() {
                infowindow.setContent('<div class="graphContainer" style="width: 800px; height: 300px;"></div>');
                infowindow.open(map,this);

                var thisTitle = this.title;


                var payload = '{"metrics":[{"tags":{"variable":["flow.' + thisTitle + '"]},"name":"flow","aggregators":[{"name":"sum","align_sampling":true,"sampling":{"value":"1","unit":"milliseconds"}}]}],"cache_time":0,"start_relative":{"value":"5","unit":"days"}}';
                sensors.fetchData(payload);
            });
        }
    };
    ...
    module.drawGraph = function(data) {
        ...
        console.log(dataset);
        $.plot($('.graphContainer'), dataset2, flotOptions);
