...
var pipes = function() {
	...
	module.draw = async function(map) {
		// Fetch pipes data
		const pipesEndpointTywyn = 'https://cardiff.wisdom-project.eu:8082/ontology/tywyn/select?query=PREFIX%20wis%3A%3Chttp%3A%2F%2Fwww.WISDOM.org%2FWISDOMontology%23%3E%0APREFIX%20rdf%3A%3Chttp%3A%2F%2Fwww.w3.org%2F1999%2F02%2F22-rdf-syntax-ns%23%3E%0ASELECT%20%20%3FXcoord_US%20%3FYcoord_US%20%3FXcoord_DS%20%3FYcoord_DS%0AWHERE%20%7B%20%0A%3FURI%20wis%3AhasUpstreamNode%20%3FUSnode%20.%0A%3FUSnode%20wis%3AhasXcoord%20%3FXcoord_US%20.%0A%3FUSnode%20wis%3AhasYcoord%20%3FYcoord_US%20.%0A%3FURI%20wis%3AhasDownstreamNode%20%3FDSnode%20.%0A%3FDSnode%20wis%3AhasXcoord%20%3FXcoord_DS%20.%0A%3FDSnode%20wis%3AhasYcoord%20%3FYcoord_DS%20.%0A%7D';
	    const pipesDataTywyn = await fetch(pipesEndpointTywyn).then(response => response.json());
	    const pipesDataObjTywyn = pipesDataTywyn.results;

	    const pipesEndpointGower = 'https://cardiff.wisdom-project.eu:8082/ontology/gower/select?query=PREFIX%20wis%3A%3Chttp%3A%2F%2Fwww.WISDOM.org%2FWISDOMontology%23%3E%0APREFIX%20rdf%3A%3Chttp%3A%2F%2Fwww.w3.org%2F1999%2F02%2F22-rdf-syntax-ns%23%3E%0ASELECT%20%20%3FXcoord_US%20%3FYcoord_US%20%3FXcoord_DS%20%3FYcoord_DS%0AWHERE%20%7B%20%0A%3FURI%20wis%3AhasUpstreamNode%20%3FUSnode%20.%0A%3FUSnode%20wis%3AhasXcoord%20%3FXcoord_US%20.%0A%3FUSnode%20wis%3AhasYcoord%20%3FYcoord_US%20.%0A%3FURI%20wis%3AhasDownstreamNode%20%3FDSnode%20.%0A%3FDSnode%20wis%3AhasXcoord%20%3FXcoord_DS%20.%0A%3FDSnode%20wis%3AhasYcoord%20%3FYcoord_DS%20.%0A%7D';
	    const pipesDataGower = await fetch(pipesEndpointGower).then(response => response.json());
	    const pipesDataObjGower = pipesDataGower.results;

	    const pipesBindingsTywyn = pipesDataObjTywyn
	        .map(it =>
	            [
	                OsGridRef.osGridToLatLon(
	                    new OsGridRef(it.Xcoord_US, it.Ycoord_US) //Xcoord_US.value, Ycoord_US.value
	                ),
	                OsGridRef.osGridToLatLon(
	                    new OsGridRef(it.Xcoord_DS, it.Ycoord_DS) //Xcoord_DS.value, Ycoord_DS.value
	                )
	            ]
	    );
